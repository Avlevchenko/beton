...
export default async function ConcreteGradePage({ params }: { params: Promise<{ grade: string }> }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SchemaMarkup pageType="product" grade={grade} pageUrl={`/beton/${grade.slug}`} />
      <Header />
      ...
      <main className="flex-1">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  <OrderDialog productTitle={grade.title}>
        ...
        <section className="py-20 px-4 bg-background">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-4xl font-bold mb-12 text-center">Области применения</h2>
        ...
        <section className="py-20 px-4 bg-muted/30">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-4xl font-bold mb-12 text-center">Преимущества {grade.grade}</h2>
        ...
        <section className="py-20 px-4 bg-background">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-4xl font-bold mb-12 text-center">Состав бетона</h2>
            <Card className="p-8">
              <dl className="space-y-4">
        ...
        <section className="py-20 px-4 bg-primary/5">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-4xl font-bold mb-12 text-center">Доставка и условия</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="p-6 text-center">
                <Truck className="h-12 w-12 text-primary mx-auto mb-4" />
                <h3 className="text-xl font-bold mb-2">Быстрая доставка</h3>
                <p className="text-muted-foreground">Доставка по Калининграду и области собственным автопарком</p>
              </Card>
              <Card className="p-6 text-center">
                <Clock className="h-12 w-12 text-primary mx-auto mb-4" />
                <h3 className="text-xl font-bold mb-2">Точно в срок</h3>
                <p className="text-muted-foreground">Гарантируем доставку в согласованное время</p>
              </Card>
              <Card className="p-6 text-center">
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-primary to-secondary text-primary-foreground">
          <div className="container mx-auto max-w-4xl text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Готовы заказать {grade.grade}?</h2>
            <p className="text-xl mb-8 opacity-90">
              Оставьте заявку и получите расчет стоимости с учетом доставки в течение 15 минут
            </p>
            <OrderDialog productTitle={grade.title}>
