        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex flex-col items-end">
              <a href={`tel:${config.phone}`} className="font-bold text-lg hover:text-primary transition-colors">
            ...
            <div className="flex gap-2">
              <Button size="icon" variant="outline" asChild className="md:hidden bg-transparent">
                <a href={`tel:${config.phone}`} aria-label="Позвонить">
                  <Phone className="h-4 w-4" />
                </a>
              </Button>
              <Button size="icon" variant="default" asChild>
                <a href={config.whatsapp || config.telegram} target="_blank" rel="noopener noreferrer" aria-label="Написать в мессенджер">
